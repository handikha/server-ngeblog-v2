...
export const USER_ALREADY_EXISTS = "Username is already taken";
export const USER_DOES_NOT_EXISTS = "User does not exists";
export const USER_NOT_VERIFIED = "Please verify your account first";
export const EMAIL_ALREADY_EXISTS = "Email is already taken";
